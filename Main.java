...
public class Main {
	...
	public void startGui() {
		...
		r1 = new kSafeRoad(RoadGrid.EAST, i1, i2);
		r2 = new kSafeRoad(RoadGrid.SOUTH, i2, i3);
		r2.setSpeedLimit(50);
		r3 = new kSafeRoad(RoadGrid.SOUTH, i3, i4);
		r4 = new kSafeRoad(RoadGrid.EAST, i5, i4);
		r5 = new kSafeRoad(RoadGrid.EAST, i6, i5);
		r6 = new kSafeRoad(RoadGrid.SOUTH, i7, i6);
		r6.setSpeedLimit(60);
		r7 = new kSafeRoad(RoadGrid.EAST, i7, i8);
		r8 = new kSafeRoad(RoadGrid.SOUTH, i1, i8);
		r8.setSpeedLimit(50);
		r9 = new kSafeRoad(RoadGrid.EAST, i8, i3);
		r9.setSpeedLimit(40);
		r10 = new kSafeRoad(RoadGrid.SOUTH, i8, i5);
	...
	public static void main(String[] args) {
		final Main mainActivity = new Main();
